...
from grid_extend import grid_extend
from remove_zero_value import remove_zero_value
...
display_grid()
grid = grid_extend(grid)
paths = get_paths(grid, max_length)
paths = remove_zero_value(paths)
if paths:
